...
<html>
	<head>
    	...
    	<!-- Title of Page -->
        <title>
       		Sarcasm Suite: Sarcasm Detection Using Semantic Incongruity
        </title>
        ...
        function showResults(){
					...
					if (xmlhttp.readyState==4 && xmlhttp.status==200){
						...
						setTimeout(function () {
							...
							if(resultAJAX == 1){
								...
								//alert(resultAJAX);
								document.getElementById("profilePic").src = "images/kevin_sarc2.png";
								...
								document.getElementById("profilePic").src = "images/kevin_nonsarc2.png";
								document.getElementById("res").innerHTML = "&nbsp;";
				...
				xmlhttp.open("GET","runSemanticInc.php?sentence="+ document.forms["sentForm"]["sarcasmInput"].value,true);
				xmlhttp.send();				
		}
    ...
    <body>
		...
		<div class="alert alert-warning" role="alert" style="font-size: 16px;">
			This demonstration is based on our paper: <strong>Aditya Joshi, Vaibhav Tripathi, Kevin Patel, Pushpak Bhattacharyya and Mark J Carman</strong>, '<a href="#" class="alert-link"><i>Are Word Embedding-based Features Useful for Sarcasm Detection?</i></a>', EMNLP 2016, Austin.</h5>
		</div>
        <div class="container" style="min-height: 500px;">
            <div class="row">
            	<div class="col-xs-12">
                	<div class="account-wall">
						<div id="res" style="text-align: center; font-size: 16px; ">&nbsp;</div><img class="profile-img" id="profilePic" src="images/kevin_nonsarc2.png" alt="">
						...
						<div id="result" style="width:905px; margin: 0 auto;"><br/>
							...
							<div id="legendLeft1" style="width:30%; float: left;"><img class="profile-img2" src="images/kevin_nonsarc2.png" alt=""><b>&nbsp;Non-Sarcastic</b></div>
							<div id="legendLeft2" style="width:30%; float: left;"><img class="profile-img2" src="images/kevin_sarc2.png" alt=""><b>&nbsp;&nbsp;&nbsp;&nbsp;Sarcastic</b></div>
						</div>
					</div>                		
                </div>
            </div>

...
consumer_key = 'Rc3kyaAZwn8PCqFCMbfX4nmwc'
consumer_secret = 'bzRKpe0fEPjV91bdOYnqSbE40TjKprSYJRQof1lTKOR9NNMoEN'
 
access_key = '733019438363070465-x95WQZtJl1l5Et01Wb1aVtENdCvGAen'
 
access_secret = 'q3S1FKwYB7QeclmB3yvx9mqdBiF4xQWk1DuWqrYffC35x'
...
def get_tweets():
    ...
    while True :
    	try:
    		listen = SListener(api, 'Sarcastic-tweets')

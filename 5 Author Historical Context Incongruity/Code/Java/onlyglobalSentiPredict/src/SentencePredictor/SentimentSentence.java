...
public class SentimentSentence {
	...
	public static void main(String[] args){
		...
		String pathtn="/Users/slfrawesome/Downloads/Intern IITB/PY/only_global/tweets"+file_num+".txt";
	    try{ BufferedReader br = new BufferedReader(new FileReader(pathtn)); 
    		...
    		FileWriter fw=new FileWriter("/Users/slfrawesome/Downloads/Intern IITB/PY/only_global/tweetsvalue"+file_num+".txt",true);
